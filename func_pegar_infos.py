...
napista = {
    ...
    "locator_link": "/html/body/div[1]/main/div/div[1]/div[3]/div/div[2]/div/div[2]/ul/li[2]/a",
...
async def pegar_links():
    ...
    for site in sites:
        ...
        async with async_playwright() as p:
            ...
            locator_dos_links = page.locator(locator_link)
            await locator_dos_links.first.wait_for()

            quantidade_links = await locator_dos_links.count()

            try:
                for i in range(quantidade_links):
                    link_elemento = locator_dos_links.nth(i)
                    link = await link_elemento.get_attribute("href")
